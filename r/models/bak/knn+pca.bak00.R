...
# plot.confusion_matrix(k_best.nn_pca.conf.mx)
k_best.nn_pca.conf.mx.chart <- plot.confusion_matrix(k_best.nn_pca.conf.mx)


# Workaround: Convert the ggplot object directly to a grid grob and draw it
grid::grid.newpage()
grid::grid.draw(ggplotGrob(k_best.nn_pca.conf.mx.chart))
