...
result 
{
  ...
  #   units_7 units_8 units_9 units_10 units_11 units_12 units_13 units_14 units_15
...
best_hp.ls <- tuner$get_best_hyperparameters()
str(best_hp.ls)

best_hp <- best_hp.ls[[1]]
...
dl_basic.final_model <- tuner$hypermodel$build(best_hp)
