...
data.dl.cnn.multiclass.dir <- file.path(cnn.data.path, "multiclass")

if(!dir.exists(data.dl.cnn.multiclass.dir))
  dir.create(data.dl.cnn.multiclass.dir)
# Obsolete 
# cnn_multiclass.train.data.path <- file.path(data.dl.cnn.multiclass.dir, "train")
# 
...
data.cnn.binary.dir <- file.path(dl.keras3.path, "binary")
